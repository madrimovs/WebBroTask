...
const PromotionWeek = () => {
    ...
    const [limitProduct, setLimitProduct] = useState(19);
    ...
    return (
        <div className="px-28 mt-10">
            <div className="flex items-center mb-4 cursor-pointer">
                <h1 className="font-medium text-xl ">Mahsulotlar</h1>
            ...
            <button
                onClick={() => setLimitProduct(limitProduct + 20)}
