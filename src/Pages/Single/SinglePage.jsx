			...
			{!isError ? (
				<div className="px-28 flex mt-10 items-start ">
					<div className="mr-20 w-1/3 h-96">
						...
						>
							<SwiperSlide>
								<img className="mr-20 w-full h-96" src={product.images} alt="" />
							</SwiperSlide>
							<SwiperSlide>
								<img
					...
					<div className="w-full pr-10">
						<div className="flex text-xs justify-between items-center text-zinc-500">
							<div className="flex items-center">
								...
								<p>5.0(11 baho)</p>
								<p className="ml-8 cursor-pointer">Ko'proq 100 buyurtma</p>
							</div>
						...
						<div className="mt-4">
							...
							<div className="flex gap-6 items-center">
								<h1 className="font-medium text-sm">{product.price + Number(price)} 000 so'm</h1>
